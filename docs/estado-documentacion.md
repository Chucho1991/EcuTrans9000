...
- Postman: OK.
  ...
  - Cobertura pendiente fuera del alcance del validador actual: módulo `Clientes`, carga/descarga de logo y flujos recientes asociados.
- README: OK.
...
- Agent/OpenAPI: OK.
  ...
  - `OpenApiConfig` describe el alcance actual: CRUD, soft delete, binarios en PostgreSQL e importación `CSV/Excel`.

## Cobertura operativa actual
- La colección Postman incluye autenticación, usuarios, sistema, vehículos y bitácora.
- README documenta:
  - módulo `Clientes` con CRUD, logo en BD e importación CSV,
...
- Extender la colección Postman y su validación para cubrir `Clientes` y endpoints de logo.
